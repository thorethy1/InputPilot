...
static OTAStartRequest request() { return {2, 100, "0.8.11", std::string(64, 'a')}; }
static FirmwareMetadataValue metadata(const char *product="InputPilot", const char *board="esp32-s3-zero-4mb") { return {product, board, "0.8.11", 2, 1}; }
