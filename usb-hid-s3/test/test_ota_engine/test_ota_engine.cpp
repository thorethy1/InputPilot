...
static OTAStartRequest request() { return {1, 100, "0.8.0", std::string(64, 'a')}; }
static FirmwareMetadataValue metadata(const char *product="InputPilot", const char *board="esp32-s3-zero-4mb") { return {product, board, "0.8.0", 1, 1}; }
